...
document.addEventListener("mousemove", function(e){
    ...
    choices.forEach(choice => {
        choice.style.transform = `rotateX(${-angleY}deg) rotateY(${angleX}deg)`;
    });
});
...
const jumpscareGif = document.getElementById("jumpscare");
    ...
    choices[i].addEventListener("click", function () {
        ...
        if (playerChoice === computerChoice) {
            ...
            if (randomChance < 50) {
                ...
                jumpscareGif.src = "Images folder/jumpscare.gif";
...
closePopup.addEventListener("click", function () {
    ...
    jumpscareGif.style.display = "jumpscare";
});
